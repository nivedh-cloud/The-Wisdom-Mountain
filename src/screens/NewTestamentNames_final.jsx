...
const NewTestamentNames = ({ lang }) => {
  const { isDarkMode } = useTheme();
  const [selectedName, setSelectedName] = useState(null);
  const [isModalOpen, setIsModalOpen] = useState(false);

  const newTestamentNames = namesOfGodData.newTestamentNames || [];
  ...
  const gridData = (newTestamentNames || []).map(name => ({
  ...
  const columns = [
    ...
    {
      dataKey: 'meaning',
      label: headers.meaning,
      width: '25%'
    },
    {
      dataKey: 'reference',
      label: headers.reference,
      width: '20%'
    },
    {
      dataKey: 'description',
  ...
  return (
    <div style={{
      ...
      <DataGrid
        ...
        lang={lang}
        title={lang === 'te' ? 'కొత్త నిబంధన దేవుని నామాలు' : 'New Testament Names of God'}
        icon={{
          Icon: FaCross,
          color: '#10b981'
        }}
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal}>
          <div style={{
            ...
            <div style={{
              ...
              <FaCross style={{ fontSize: '2rem', color: '#fbbf24' }} />
              <div>
            ...
            <div style={{ padding: '0 20px 20px' }}>
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ 
                  ...
                  borderBottom: `2px solid ${isDarkMode ? '#10b981' : '#059669'}`,
                  paddingBottom: '8px',
                  marginBottom: '15px'
                }}>
...
export default NewTestamentNames;
